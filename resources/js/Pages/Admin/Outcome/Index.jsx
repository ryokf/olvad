            ...
            <Admin title="Pengeluaran" subtitle={`${date.day}, ${date.dateNumber} ${date.month} ${date.year}`}>
                <div className="my-4 pl-4 flex gap-2">
                    <Flowbite theme={{ theme: CustomTheme }}>
                        <Button outline={!isBuyType} color={isBuyType ? 'primary' : 'light'} onClick={() => setIsBuyType(true)}>Pembelian</Button>
                        <Button outline={isBuyType} color={isBuyType ? 'light' : 'primary'} onClick={() => setIsBuyType(false)}>Sosial</Button>
                    </Flowbite>
                </div>
                {
...
//             "primary" : "text-white bg-primary-light border border-transparent enabled:hover:bg-primary-medium focus:ring-4 focus:ring-primary-light dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800",
