    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-24 pb-12">
            <div className="max-w-4xl mx-auto px-6">
                ...
                {/* Estimated Time */}
                <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl p-8 shadow-lg text-white mb-6 text-center">
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                    ...
                    <button className="py-4 px-6 bg-tertiary hover:bg-tertiary-dark rounded-full font-semibold text-white shadow-lg hover:shadow-xl transition-all hover:scale-105">
                        Hubungi Kami
                    </button>
                </div>
