    ...
    <section className="py-20 sm:py-24 bg-gradient-to-b from-white to-amber-50">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                ...
                <div className="relative h-64 bg-gradient-to-br from-amber-50 to-orange-50 overflow-hidden">
                  {/* Label */}
                  {product.label && (
                    <div className="absolute top-3 right-3 bg-tertiary text-white text-xs font-bold px-3 py-1.5 rounded-full z-10 shadow-md">
                      {product.label}
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button
                      className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl transition-all shadow-md ${hoveredId === product.id
                        ? "bg-tertiary text-white scale-110 shadow-lg"
        ...
        <div className="text-center mt-16">
          <a href="/menu" className="btn-hover px-10 py-4 bg-amber-700 text-white rounded-full font-semibold text-lg hover:bg-amber-800 shadow-lg hover:shadow-xl transition-all inline-block">
            Lihat Semua Menu
          </a>
        </div>
      </div>
