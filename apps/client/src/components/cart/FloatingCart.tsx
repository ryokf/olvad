    ...
    return (
        <>
            ...
            <button
                ...
                className="md:hidden fixed bottom-6 right-6 z-40 bg-tertiary hover:bg-tertiary-dark rounded-full shadow-2xl text-white p-5 hover:scale-110 transition-transform animate-bounce-subtle"
            >
                {/* Badge */}
            ...
            <div className="hidden md:block fixed bottom-0 left-0 right-0 z-40">
                <div className="max-w-7xl mx-auto px-6 pb-6">
                    <button
                        onClick={() => setIsDrawerOpen(true)}
                        className="w-full bg-tertiary hover:bg-tertiary-dark rounded-2xl shadow-2xl text-white p-5 hover:scale-105 transition-all"
                    >
