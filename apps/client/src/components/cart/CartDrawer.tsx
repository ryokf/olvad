            ...
            <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-white shadow-2xl flex flex-col animate-slide-in-right">
                ...
                {items.length === 0 ? (
                    <div className="flex-1 flex flex-col items-center justify-center p-6">
                        ...
                        <button
                            onClick={onClose}
                            className="mt-6 px-8 py-3 bg-tertiary hover:bg-tertiary-dark rounded-full font-bold text-white transition-all shadow-lg hover:shadow-xl hover:scale-105"
                        >
                            Lihat Menu
                        </button>
                    </div>
                    ...
                    <>
                        ...
                        <div className="p-6 border-t border-gray-200 bg-gray-50 space-y-4">
                            ...
                            <a
                                href="/checkout"
                                className="block w-full py-4 bg-tertiary hover:bg-tertiary-dark rounded-full font-bold text-lg text-white transition-all shadow-lg hover:shadow-xl hover:scale-105 text-center"
                            >
                                Lanjut ke Checkout
                            </a>
                        </div>
