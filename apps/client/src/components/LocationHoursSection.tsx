    ...
    <section className="py-20 sm:py-24 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-16 space-y-4">
          <p className="font-semibold text-sm uppercase tracking-wide text-tertiary-dark">
            Lokasi & Jam
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 bg-white/10 rounded-2xl border border-white/20 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-4">
                <div
                  className={`w-4 h-4 rounded-full animate-pulse shadow-lg ${isOpen ? 'bg-tertiary' : 'bg-red-400'}`}
                ></div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 rounded-xl p-6">
                <p className="text-sm mb-2 font-semibold text-tertiary-dark">Lokasi Utama</p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3 bg-white/5 rounded-xl p-6">
                <a
                  ...
                  className="text-gray-300 hover:text-tertiary transition-colors flex items-center gap-3 text-lg"
                >
            ...
            {/* CTA */}
            <button
              className="btn-hover w-full px-8 py-4 bg-tertiary hover:bg-tertiary-dark text-white font-bold rounded-full transition-colors shadow-lg hover:shadow-xl"
            >
              Buka di Maps
            </button>
          </div>
          ...
          {/* Map Placeholder */}
          <div className="h-96 lg:h-full min-h-150 rounded-2xl overflow-hidden border border-white/20 bg-gradient-to-br from-amber-900/20 to-orange-900/20 backdrop-blur-sm">
