        ...
        <div className="min-h-screen flex">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
                <div className="w-full max-w-md">
                    ...
                    {/* Header */}
                    <div className="mb-8">
                        <h2 className="text-heading-3 text-secondary-800 mb-2">
                            Buat Akun
                        </h2>
                        <p className="text-secondary-400">
                            Daftar untuk mulai memesan dengan mudah
                        </p>
                    </div>

                    {/* Success Message */}
                    {success && (
                        <div className="mb-6 p-4 bg-green-50 border border-green-200 text-green-700 rounded-xl text-sm flex items-center gap-3 animate-fade-in-up">
                            <svg
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-bl from-primary-600 via-primary-400 to-tertiary-300">
                {/* Decorative Blobs */}
                <div className="absolute -top-24 -right-24 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-blob" />
                <div className="absolute top-1/2 -left-24 w-80 h-80 bg-primary-200/30 rounded-full blur-3xl animate-blob animation-delay-2000" />
                <div className="absolute -bottom-24 right-1/3 w-72 h-72 bg-tertiary-200/20 rounded-full blur-3xl animate-blob animation-delay-4000" />
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full px-16 text-white">
                    ...
                    <p className="text-lg text-white/80 text-center max-w-md leading-relaxed">
                        Dapatkan akses mudah untuk memesan kopi & roti artisan favorit kamu
                    ...
                    <div className="mt-10 space-y-4 text-white/70">
                        <div className="flex items-center gap-3">
                            ...
                            <span>Pesan cepat tanpa antri</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <svg
                                className="w-5 h-5 text-white"
                            ...
                            <span>Lacak pesananmu secara real-time</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <svg
                                className="w-5 h-5 text-white"
                            ...
                            <span>Promo eksklusif untuk member</span>
                        </div>
                    </div>
